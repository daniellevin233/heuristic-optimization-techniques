...
TODO: Analyze the objective value improvements, statistical significance (Wilcoxon test results), and trends across
instance sizes. Discuss whether tuning benefits are consistent or vary by instance size. Consider whether the
computational investment in tuning (50 trials × 5 instances × time budget) is justified by the improvement margin.

\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{ALNS-Default_vs_ALNS-Tuned_comparison_placeholder}
