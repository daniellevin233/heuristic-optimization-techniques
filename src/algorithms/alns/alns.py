...
def test_alns_small_instance():
    """Test ALNS on a small instance (n=50)."""
    ...
    initial_solution = SCFPDPSolution(instance, use_delta_eval=True)
...
if __name__ == '__main__':
    success = test_alns_small_instance()
